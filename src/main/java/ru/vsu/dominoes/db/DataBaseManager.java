...
public class DataBaseManager {
  public Pair<List<PlayerDataBase>, List<GameStatistic>> saveResults(Game game, Player[] boardPlayers) {
    ...
    return new Pair<>(dataStorage.savePlayers(players), dataStorage.saveGame(gameStatistics));
  }
